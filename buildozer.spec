...
# (string) Supported orientation (one of landscape, portrait, portrait-reverse or landscape-reverse)
...
# (int) Android NDK API to use. This is the minimum API your NDK should support.
android.ndk_api = 21
